...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $telepon = trim($_POST['NomorTelepon'] ?? '');
    ...
    if (empty($nama)) {
        ...
        if (!empty($_POST['PelangganID'])) {
            ...
            $query = "UPDATE pelanggan SET NamaPelanggan = '$nama', Alamat = '$alamat', NomorTelepon = '$telepon' WHERE PelangganID = $id";
            if (mysqli_query($koneksi, $query)) {
                $message = 'Data pelanggan berhasil diperbarui.';
            } else {
                $message = 'Gagal memperbarui pelanggan: ' . mysqli_error($koneksi);
            }
        } else {
            ...
            if (mysqli_query($koneksi, $query)) {
                ...
                $message = 'Gagal menambahkan pelanggan: ' . mysqli_error($koneksi);
            }
        }
